...
//Updated Home Component i.e Claude
        ...
        <div className="meetPage">
            ...
            <div className="mainContent">
                <div className="leftContent">
                    ...
                    <p>Connect, collaborate, and celebrate from anywhere with ROVAMS Connect</p>
                    ...
                    <div className="actionButtons">
                        ...
                        <div className="joinSection">
                            <TextField
                                ...
                                fullWidth
                                InputProps={{
                                    startAdornment: <LinkIcon color="action" style={{marginRight: '8px'}} />
                                }}
                            />
                            <Button 
                                onClick={handleJoinVideoCall}
