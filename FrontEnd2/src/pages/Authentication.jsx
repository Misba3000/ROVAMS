      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid
          ...
          sx={{
            ...
            background: "linear-gradient(135deg, #004BB5 0%, #2593E6 50%, #6A8FA0 100%)",
            backgroundSize: "cover",
            backgroundPosition: "center",
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          >
            ...
            <Box sx={{ position: "relative", height: 200, width: "80%", mb: 6 }}>
              {/* Sound waves */}
              {[...Array(20)].map((_, index) => (
                <Box
                  ...
                  sx={{
                    ...
                    bottom: 0,
                    width: "3px",
                    height: `${30 + Math.sin((index + wave) * 0.3) * 20 + Math.cos((index + wave) * 0.5) * 25}px`,
                    backgroundColor: "rgba(255, 255, 255, 0.8)",
                    borderRadius: "2px",
            ...
            >
              <VideocamIcon sx={{ fontSize: 60, color: "white" }} />
            </Box>
            ...
            <Box sx={{ textAlign: "center" }}>
              ...
              >
                {["HD Video", "Secure", "Easy to Join"].map((feature, index) => (
                  <Box
                    key={index}
                    sx={{
                      padding: "6px 16px",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ROVAMS
                <Box component="span" sx={{ color: "#10B981" }}>CONNECT</Box>
              </Typography>
            </Box>
            ...
            {formState === 0 && (
              <>
                ...
                >
                  <Typography
                    sx={{ width: "100%", textAlign: "center", pr: 4 }}
                  >
                    Sign in with Google
                  </Typography>
                </Button>
            ...
            >
              ...
              {formState === 0 && (
                <Box sx={{ textAlign: "right", mt: 1 }}>
                  <Link href="#" variant="body2" sx={{ color: "#6B7280" }}>
                    {/* Forgot Password? */}
                  </Link>
                </Box>
              )}
              ...
              <Box sx={{ textAlign: "center", mt: 2 }}>
                <Typography variant="body2" color="text.secondary">
                  ...
                  >
                    {formState === 0 ? "Sign Up here" : "Sign In"}
                  </Link>
                </Typography>
              </Box>
            </Box>
